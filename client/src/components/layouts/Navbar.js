  ...
  return (
    <nav id="myNavbar" className="nav nav-wrapper scrollspy">
      <div className="container">
        ...
        <Link to= "/" className= "brand-logo">AsteroidsHunter</Link>
        ...
        <ul className="sidenav" id="mobilenav">
          ...
          <li><NavLink to="/asteroids" className="sidenav-close" ><i className="fa fa-globe"></i>Asteroids</NavLink></li>
        ...
        <ul className="right hide-on-med-and-down">
          ...
          <li><NavLink to="/asteroids">Asteroids</NavLink></li>           
